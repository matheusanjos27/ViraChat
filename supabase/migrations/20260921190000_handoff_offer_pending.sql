-- Oferta de handoff: IA pergunta se o cliente quer atendente antes de transferir.

alter table public.conversations
  add column if not exists handoff_offer_pending_at timestamptz;

comment on column public.conversations.handoff_offer_pending_at is
  'Quando preenchido, a IA ofereceu transferir para humano e aguarda sim/não.';
